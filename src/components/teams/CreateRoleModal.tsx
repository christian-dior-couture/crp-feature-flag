...
export default function CreateRoleModal({ open, onClose, onCreate }: CreateRoleModalProps) {
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth automation-id="create-role-modal">
