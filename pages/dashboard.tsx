...
const DashboardPage = () => {
  const Header = () => (
    <div className="md:flex md:items-center md:justify-between" data-automation-id="dashboard-header">
      ...
      <div className="mt-4 flex md:ml-4 md:mt-0">
        <button
          ...
          data-automation-id="settings-button"
        >
        ...
        <button
          ...
          data-automation-id="create-flag-button"
        >
  ...
  const EmptyState = () => (
    <div className="text-center py-12" data-automation-id="empty-state">
        ...
        <div className="mt-6">
            <button
                ...
                data-automation-id="empty-state-create-button"
            >
                <Plus className="-ml-0.5 mr-1.5 h-5 w-5" aria-hidden="true" />
                Create Flag
            </button>
